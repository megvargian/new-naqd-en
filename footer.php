...
<footer class="pt-5">
    <div class="container">
        ...
        <div class="row justify-content-lg-between justify-content-end pb-4">
            <div class="col-lg-5 col-12 pb-lg-0 pb-4 justify-content-start d-flex align-items-center order-lg-0 order-1">
            ...
            <div class="col-lg-1 col-4 pb-lg-0 pb-2 order-lg-1 order-0">
